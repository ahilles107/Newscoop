...
class Comment
{
    ...
    /**
     * Composite keys are not perfect, we still need this for some things.
     *
    ...
    {
        $statusEnum = array_flip(self::$status_enum);
     ...
     * @return Newscoop\Entity\Comment
     */
    public function setThread(\Newscoop\Entity\Article $thread)
    {
        $this->thread = $thread;
